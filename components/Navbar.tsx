...
export default function Navbar() {
  return (
    <nav className='flex flex-col px-2 md:px-4 lg:px-28 pt-4 gap-2 shadow-md bg-white dark:bg-darkBody'>
      ...
      <div className='flex items-center gap-12'>
        <button type='button' className='flex items-center gap-2 border-t border-x rounded-t-lg px-2 pt-2 pb-1 bg-light dark:bg-darkBody'>
